...
{
 var images_section=document.querySelector("#image");
 var content=""

  for(var i=0;i<images.length;i++)
  {
    content+= "<figure><img alt='" + images[i].alt + "'" + 
    " src='" + images[i].url + "' /><figcaption>"+images[i].caption+"</figcaption></figure>";

   
  }
 
 images_section.innerHTML=content;
}