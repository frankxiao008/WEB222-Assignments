...
{
  var table_section=document.querySelector("#table");
  var content="<table border='1'><tr><th>First Name</th><th>Last Name</th><th>Age</th><th>Email</th></tr>";

  for(var i=0;i<users.length;i++)
  {
      content+="<tr><td>"+users[i].first_name+"</td><td>"+users[i].last_name+"</td><td>"+users[i].age+"</td><td>"+"<a href='mailto:'>"+users[i].email+"</a></td></tr>";

  }

content+="</table>";
table_section.innerHTML=content;
}